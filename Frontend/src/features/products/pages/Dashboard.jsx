        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6">
          <div>
            <h1 className="text-3xl md:text-5xl font-light tracking-tight text-[#2C2C2A] mb-2">
              Seller <span className="font-medium text-[#8A8678]">Dashboard</span>
            </h1>
        ...
        {sellerProducts && sellerProducts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {sellerProducts.map((product) => (
              <div
                key={product._id}
                className="bg-[#FFFFFF] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 group flex flex-col border border-[#E0DFD8]"
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-[#E0DFD8]">
                    ...
                    <button className="text-[#2C2C2A] hover:text-[#8A8678] transition-colors text-sm font-medium uppercase tracking-widest">
                      Edit
                    </button>
                  </div>
                </div>
          ...
          <div className="flex flex-col items-center justify-center py-32 bg-[#FFFFFF] rounded-3xl border border-[#E0DFD8] shadow-sm">
            <div className="w-24 h-24 bg-[#F0EFEA] rounded-full flex items-center justify-center mb-8 border border-[#E0DFD8]">
              <svg className="w-10 h-10 text-[#8A8678]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
              </svg>
            </div>
            <h3 className="text-2xl font-medium text-[#2C2C2A] mb-3">No products yet</h3>
